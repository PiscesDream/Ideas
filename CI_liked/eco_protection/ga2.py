    ...
    def fit(self):            
        ...
        while (self.fitness_thresold == None and iteration < self.iter_maximum) or \
            ...
            if self.best_fitness == None or self.cmp_f(fitness_max, self.best_fitness):
                ...
                global f
                f.write('%03dth  generation|\tbest fitness:\t%lf|\tbest child fitness:\t%lf\t|avr fitness:\t%lf' % (iteration, self.best_fitness,fitness_max, mean(fitness))+'\n')
                f.write(repr(self.best_biont)+'\n')

            print '%03dth  generation|\tbest fitness:\t%lf|\tbest child fitness:\t%lf\t|avr fitness:\t%lf' % (iteration, self.best_fitness,fitness_max, mean(fitness))
            print self.best_biont
